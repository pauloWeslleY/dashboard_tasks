...
import {
  VERIFY_PATHNAME,
  type VerifyPathnameType,
} from '@/app/_components/types/verify-pathname.type';

type IsNavItemActiveProps = Pick<
  NavItemConfig,
  'disabled' | 'external' | 'href' | 'matcher'
> & {
  pathname: string;
};
